    ...
    return (
        <div className="g-contacto" align="center">
            <Row className="show-grid show-grid-contactame ">
                ...
                <h4 className="g-titulo-secciones"><i class="fa fa-thumb-tack" aria-hidden="true"></i>  Visítanos</h4>
                ...
                <h4 className="g-titulo-secciones"> <i class="fa fa-user" aria-hidden="true"></i> Comunicate</h4>
                    <div className="g-comunicate">
                        <h5 className="g-datos-comunicate"><i class="fa fa-phone-square " aria-hidden="true"></i> 951095509 - 953897588</h5>
                        <h5 className="g-datos-comunicate"><i class="fa fa-envelope " aria-hidden="true"></i> ventas@avantecperu.com</h5>
                        <h5 className="g-datos-comunicate"><i class="fa fa-skype" aria-hidden="true"> </i> avantecperu@msn.com</h5>
                    </div>
                </Col>
                <Col className="g-icon-contact" xs={12} md={3}>
                <h4 className="g-titulo-secciones"><i class="fa fa-search" aria-hidden="true"></i> Búscanos</h4>
                    <div className="g-buscanos">
                        <a className="cont-icon " href="https://www.facebook.com/supertecnologias/?pnref=lhc">
                            <i class="fa fa-facebook-square fa-3x g-facebook " aria-hidden="true"></i>
                        </a>
                        <a className="cont-icon " href="https://www.youtube.com/user/superbyteperu">
                            <i class="fa fa-youtube-play fa-3x g-youtube" aria-hidden="true"></i>
                        </a>
                    </div>
                    <h4 className="g-titulo-secciones"><i class="fa fa-envelope" aria-hidden="true"></i>  Suscribete</h4>
                ...
                {/* <Col className="g-icon-contact" xs={12} md={2}>
                    <i class="fa fa-envelope" aria-hidden="true"> Suscribete</i><br />
                    <div className="g-suscribete">
